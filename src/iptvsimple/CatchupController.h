...
public:
  ...
  // playback that consumes it. GetChannelStreamProperties reads this to play
  // the reference-playlist URL through the catchup inputstream, regardless of
  // the global transcode/bitrate/inputstream settings — the state is only
  // consumed once ProcessChannelForPlayback runs.
